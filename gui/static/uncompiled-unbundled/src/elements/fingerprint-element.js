...
window.customElements.define(FingerprintElement.is, FingerprintElement); // CP from https://github.com/Valve/fingerprintjs2/blob/f4d40678ae6f8ecfc91caa9395783c7e3485ed88/fingerprint2.js
...
Fingerprint2.prototype = {
  ...
  audioKey: function (keys, done) {
    ...
    this.each([['threshold', -50], ['knee', 40], ['ratio', 12], ['reduction', -20], ['attack', 0], ['release', 0.25]], function (item) {
