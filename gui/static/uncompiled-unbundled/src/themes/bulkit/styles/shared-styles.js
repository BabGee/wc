...
@media only screen and (min-width: 1024px) {
  ...
  .cd-dropdown-content > .has-children > a.is-active {
    ...
    box-shadow: inset 2px 0 0 var(--app-default-color);
  }
...
nav .cd-dropdown-content  li:hover ul{display:block; visibility: visible}
...
@media screen and (min-width: 769px), print {
  ...
  .column.is-2, .column.is-2-tablet {
    ...
    .is-product-grid .column.is-2, .column.is-2-tablet {
    padding: 15px;
    flex: none;
    width: 21%;
  }
