...
function loadDist() {
  ...
  objectStore.openCursor().onsuccess = function (event) {
    var cursor = event.target.result; // if there is still another cursor to go, keep runing this code
...
function addData(k, v) {
  ...
  var transaction = db.transaction(["settings"], "readwrite"); // report on the success of the transaction completing, when everything is done
  ...
  console.log(objectStore.autoIncrement); // Make a request to add our newItem object to the object store
...
function openDb() {
  ...
  DBOpenRequest.onsuccess = function (event) {
    console.log('Database initialised.'); // store the result of opening the database in the db variable. This is used a lot below
