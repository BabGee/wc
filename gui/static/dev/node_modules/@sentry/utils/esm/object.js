import { isElement, isError, isEvent, isPrimitive, isSyntheticEvent } from "./is.js";
import { Memo } from "./memo.js";
import { htmlTreeAsString } from "./misc.js";
...
function getWalkSource(value) {
  ...
  if (isEvent(value)) {
    var source = {};
    source.type = value.type; // Accessing event.target can throw (see getsentry/raven-js#838, #768)
