...
Polymer({
  ...
  validate: function () {
    ...
    var valid = this.$.input.validate() && this.value.length == this._requiredLength || !this.required && this.value == '';
    this.invalid = !valid; // Update the container and its addons (i.e. the custom error-message).
