...
Polymer({
  ...
  behaviors: [PaperInputBehavior, IronValidatableBehavior, IronFormElementBehavior],
  properties: {
    /**
  ...
  _onCardTypesChanged: function (cardTypes, oldValue) {
    if (this.value) this._handleAutoValidate();
  },
  ...
  _onValueChanged: function (value, oldValue) {
    ...
    this.updateValueAndPreserveCaret(formattedValue.trim()); // If the character right before the selection is a newly inserted
  ...
  validate: function () {
    ...
    this.cardType = valid ? result.card_type.name : ''; // Update the container and its addons (i.e. the custom error-message).
