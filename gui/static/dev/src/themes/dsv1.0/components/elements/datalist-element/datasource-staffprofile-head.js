...
export class DataSourceStaffProfileHead extends LitElement {
  render() {
    return html`
        <style>
            :host {
  ...
  static get is() {
    return 'datasource-staffprofile-head';
  }
...
customElements.define(DataSourceStaffProfileHead.is, DataSourceStaffProfileHead);