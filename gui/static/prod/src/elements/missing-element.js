...
</g></g> </svg>&nbsp; An error occured loading we are working on the issue</strong></div>`}static get is(){return"missing-element"}static get properties(){return{msg:String}}}window.customElements.define(MissingElement.is,MissingElement);