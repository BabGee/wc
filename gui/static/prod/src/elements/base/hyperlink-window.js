...
export const HyperlinkWindowBase = class extends utilsMixin(BaseElement) {
  ...
  _linkClick(evt) {
    evt.preventDefault(); // var encodedParams = this.objToQueryString(formParams);

    window.open(this.e.defaultValue, '_blank', 'location=yes,height=570,scrollbars=yes,status=yes');
  }
