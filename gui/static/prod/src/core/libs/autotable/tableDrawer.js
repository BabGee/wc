import { FONT_ROW_RATIO } from "./config.js";
import { addTableBorder, applyStyles, applyUserStyles, getFillStyle } from "./common.js";
import { Cell, Row } from "./models.js";
import state from "./state.js"; // const assign = require('object-assign');

import { assign } from "./polyfills.js";
import { default as autoTableText } from "./autoTableText.js";
export function drawTable(table) {
  ...
  table.startPageNumber = state().pageNumber(); // An empty row used to cached cells those break through page
