import{html,DASHBOARD_STYLES,BULMA_STYLES,LANDING_STYLES,SectionPElementDsc}from"../../../../components/adaptive-ui.js";class SectionPrice extends SectionPElementDsc{renderDefault(){return html`
        ${BULMA_STYLES}
     ${DASHBOARD_STYLES} 
     ${LANDING_STYLES}
        <style>
