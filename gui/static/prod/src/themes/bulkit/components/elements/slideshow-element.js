import{html,BULMA_STYLES,DASHBOARD_STYLES,LANDING_STYLES,SlideshowElementBase}from"../../../../components/adaptive-ui.js";class SlideshowElement extends SlideshowElementBase{renderDefault(){return html`
     ${BULMA_STYLES}
     ${DASHBOARD_STYLES} 
     ${LANDING_STYLES}
  <style>
