import{LitElement,html,css}from"../../../../../../node_modules/lit-element/lit-element.js";export const CONNECTION_BEG="BEG";export const CONNECTION_END="END";export const CONNECTION_CON="CON";class UssdSimulatorPreview extends LitElement{constructor(){super();this.state=CONNECTION_CON}static get properties(){return{menus:String,connection:String,state:String}}render(){return html`
        <style>
        *{
