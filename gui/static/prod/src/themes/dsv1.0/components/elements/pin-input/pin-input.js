  ...
  right: 37px;
    ...
    <div class="column">
      <div class="input-mixin input-effect">
       ...
       style="position: absolute;right: 50px;top: 99px!important"; >
       <iron-icon id="eye" icon="icons:visibility-off"
       @click="${this.reveal}" > </iron-icon> </span>
