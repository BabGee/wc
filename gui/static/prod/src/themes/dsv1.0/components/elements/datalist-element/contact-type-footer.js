...
import { ContactTypeFooterStyles } from "./datalist-element-styles/contact-type-footer-css.js";
...
export class ContactTypeFooter extends LitElement {
  static get styles() {
    return [DatalistFooterStyles, ContactTypeFooterStyles, css`
        :host {
          display: block;
        }
      `];
...
customElements.define(ContactTypeFooter.is, ContactTypeFooter);