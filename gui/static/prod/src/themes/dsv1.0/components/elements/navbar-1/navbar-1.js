...
import { NavbarOneStyles } from "./navbar-1-css.js";
/* eslint max-len: ["error", { "ignoreTemplateLiterals": true }]*/

class Navbar1 extends NavbarBase {
  static get styles() {
    return [NavbarOneStyles, css`
        :host {
          display: block;
        }
      `];
      ...
      <div class="container">
        ...
        <div id="navbarBasicExample" class="navbar-menu">
          ...
          ${this.interface.pageGroups.map((pageGroup, pageGroupIndex) => html`
            ...
            ${menu.title == "Sign in" || menu.title == "Log in" || menu.title === "Sign up" || menu.title == "Register" ? html`` : html`
