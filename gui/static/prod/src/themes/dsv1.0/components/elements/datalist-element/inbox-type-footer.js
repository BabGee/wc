...
import { InboxTypeFooterStyles } from "./datalist-element-styles/inbox-type-footer-css.js";
/* eslint max-len: ["error", { "ignoreTemplateLiterals": true }]*/

export class InboxTypeFooter extends LitElement {
  static get styles() {
    return [DatalistFooterStyles, InboxTypeFooterStyles, css`
        :host {
          display: block;
        }
      `];
...
customElements.define(InboxTypeFooter.is, InboxTypeFooter);