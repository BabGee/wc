...
import { StaffProfileTypeFooterStyles } from "./datalist-element-styles/staffprofile-type-footer-css.js";
/* eslint max-len: ["error", { "ignoreTemplateLiterals": true }]*/

export class StaffProfileTypeFooter extends LitElement {
  static get styles() {
    return [DatalistFooterStyles, StaffProfileTypeFooterStyles, css`
        :host {
          display: block;
        }
      `];
