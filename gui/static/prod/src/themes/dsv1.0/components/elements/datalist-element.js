import{dataSourceMixin,LitElement,html,css,DataListElementBase}from"../../../../components/adaptive-ui.js";class DataSourceList extends dataSourceMixin(LitElement){static get styles(){return css`
    :host {
                display: block;
            }
