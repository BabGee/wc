import{html,ImageInputBase}from"../../../../components/adaptive-ui.js";class ImageInput extends ImageInputBase{renderDefault(){return html`
    ...
    <div class="mainwrapper drop-area">
      <form id="file-form" class="upload-form is-flex">
        ...
        `}constructor(){super()}getValue(){return this.value}firstUpdated(){}// let preview = this.shadowRoot.querySelector(".file-preview img");
...
/**
   * from ImageInputBase
   * @override
   */updatePreview(src){var display=this.qs("#display");display.src=src}/**
     * Override to display a message to user
     * @param message
     */updateUploadMessage(message){const display=this.shadowRoot.querySelector("#label");display.textContent=message}// /**
//  * Cancel Last Upload
//  * @param evt
//  */
// cancelUpload(evt) {
...
// }
handleFile(){const fileInput=this.shadowRoot.querySelector("[type=\"file\"]");this.uploadImage(fileInput)}/**
     * from SerializableElement
     * @override
...
/**
   * Cancel Last Upload
   * @param evt
   */cancelUpload(evt){this.resetUpload();this.updateUploadMessage("")}// uploadFile(fileInput) {
