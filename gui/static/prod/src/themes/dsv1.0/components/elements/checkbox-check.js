import{html,CheckboxCheckBase}from"../../../../components/adaptive-ui.js";class CheckboxCheck extends CheckboxCheckBase{createRenderRoot(){return this}renderDefault(){return html`
<style>
.switch {
  position: relative;
...
<label class="switch">
  ...
  <span>${this.name}</span>
        ...
        `}getInput(){return this.qs("#input")}getValue(){return this.shadowRoot.querySelector("#input").checked?"on":"off"}valid(Validation){this.shadowRoot.querySelector(".validation-info").style.display="none";// Revert general text content
