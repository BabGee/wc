...
next(){if(this.monthYearCalenderVisibile){const monthYearView=this.shadowRoot.getElementById("monthAndYear");this.currentYear++;monthYearView.innerText=this.currentYear}else{//Remove active color by default
