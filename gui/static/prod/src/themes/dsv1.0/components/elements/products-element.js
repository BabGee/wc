import{html,SectionPElementDsc}from"../../../../components/adaptive-ui.js";class ProductsElement extends SectionPElementDsc{constructor(){super()}render(){return html`
    ...
    `)}
        ...
        `}static get is(){return"products-element"}static get properties(){return{}}}customElements.define(ProductsElement.is,ProductsElement);var productsElement={ProductsElement:ProductsElement};export{productsElement as $productsElement,ProductsElement};