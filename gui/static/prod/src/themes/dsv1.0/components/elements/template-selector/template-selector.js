...
`;var templateSelectorCss={TemplateSelectorStyle:TemplateSelectorStyle};class TemplateSelector extends TemplateSelectorBase{static get styles(){return[TemplateSelectorStyle,css`
    ...
    `}}customElements.define(TemplateSelector.is,TemplateSelector);var templateSelector$1={TemplateSelector:TemplateSelector};export{templateSelector as $templateSelector,templateSelectorCss as $templateSelectorCss,templateSelector$1 as $templateSelector$1,TemplateSelectorBase,TemplateSelectorStyle,TemplateSelector};