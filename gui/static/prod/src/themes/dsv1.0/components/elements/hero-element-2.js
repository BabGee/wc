import{LitElement,html}from"../../../../components/adaptive-ui.js";class HeroElement extends LitElement{constructor(){super()}render(){return html`
        <style>
            canvas {
                position: absolute;
                top: 0;
        ...
        `}static get is(){return"hero-element"}}customElements.define(HeroElement.is,HeroElement);