...
import { updateView } from "../actions/template.js";
import { VIEW_MODE_MAIN } from "./templates/page-view-element.js";
...
class AdaptiveUi extends connect(store)(LitElement) {
  ...
  firstUpdated(changedProperties) {
    ...
    */
    // todo should be passed through app state

    window.csrfToken = this.csrftoken; // on Escape key click, close the section dialog modal
    ...
    document.onkeydown = function (evt) {
      ...
      if (isEscape) {
        // todo this does not clear the dialogsStack, Test for any bad effects?
