...
<div class="loading-bar"></div>
  ...
  elementPath(el) {
    ...
    let elp = this.checkTheme(window.THEME, eln);
    return {
      'path': elp,
      'name': eln,
  ...
  checkTheme(theme, eln) {
    if (theme == 'bulkit') {
      return `../themes/${theme}/components/elements/${eln}.js`;
    } else {
      return `../themes/${theme}/components/elements/${eln}/${eln}.js`;
    }
  }
