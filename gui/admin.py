...
class PermissionAdmin(admin.ModelAdmin):
	list_display = ('name','page','gateway_list','status','xframe_exempted','csrf_exempted',)
admin.site.register(Permission, PermissionAdmin)

class RefererHostAdmin(admin.ModelAdmin):
	list_display = ('host', 'permissions','status','description','xframe_exempted','csrf_exempted')
