import{css,html,NavbarBase}from"../../../../../components/adaptive-ui.js";const NavbarElevenStyles=css`
nav {
	font-size: 16px;
}
.bind-box {
...
`;var navbar11Css={NavbarElevenStyles:NavbarElevenStyles};class Navbar11 extends NavbarBase{static get styles(){return[NavbarElevenStyles,css`
      :host{
        display: block;
      }
